  ...
  <section id="team" className="py-24">
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <span className="inline-block mt-3 text-[10px] font-semibold text-amber-500/90 bg-amber-500/10 px-1.5 py-0.5 rounded">Sample Team — placeholder profiles</span>
      </motion.div>
