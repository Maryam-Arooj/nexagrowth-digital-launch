  ...
  <section id="work" className="py-24 bg-card/50">
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <span className="inline-block mt-3 text-[10px] font-semibold text-amber-500/90 bg-amber-500/10 px-1.5 py-0.5 rounded">Sample Data — illustrative examples, not verified results</span>
      </motion.div>
