...
const Hero = () => (
  <section className="min-h-[88vh] flex items-center pt-16 relative overflow-hidden">
    {/* Subtle background accent */}
    <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-primary/[0.04] blur-[120px] -translate-y-1/3 translate-x-1/4" />
    ...
    <div className="container mx-auto px-4 relative z-10">
      <div className="max-w-3xl">
        <motion.div
          ...
          className="inline-flex items-center gap-2 border border-border rounded-full px-4 py-1.5 mb-6 bg-card"
        >
        ...
        <motion.h1
          ...
          className="font-heading text-4xl sm:text-5xl md:text-[56px] font-extrabold tracking-tight leading-[1.08] text-foreground"
        >
